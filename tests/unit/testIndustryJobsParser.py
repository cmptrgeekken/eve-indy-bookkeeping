...
from functions.industryJobsParser.industryJobsParser import IndustryJobsParser

from functions.industryJobsParser.industryJobsParser import lambda_handler


class IndustryJobsTest(unittest.TestCase):
    def setUp(self):
        self.sut = IndustryJobsParser()

    def tearDown(self):
        mock.patch.stopall()

    def test_lambda(self):
        main_method = mock.patch.object(IndustryJobsParser, 'main').start()
    ...
    def test_build_urls(self):
        expected = [
            {'apiId': 123,
             'url': 'https://api.eveonline.com/corp/IndustryJobs.xml.aspx?keyID=123456&vCode=abc'},
            {'apiId': 123,
             'url': 'https://api.eveonline.com/corp/IndustryJobsHistory.xml.aspx?keyID=123456&vCode=abc'},
            {'apiId': 321, 'url': 'https://api.eveonline.com/char/IndustryJobs.xml.aspx?keyID=654321&vCode=cde'},
